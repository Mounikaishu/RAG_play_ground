...
function App() {
  ...
  const uploadCompareResumes = async () => {
    ...
    try {
      ...
      const res = await axios.post("http://127.0.0.1:8000/upload-compare", fd);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const res = await axios.post("http://127.0.0.1:8000/chat", fd);
  ...
  const sendCompareMessage = async () => {
    ...
    try {
      ...
      const res = await axios.post("http://127.0.0.1:8000/compare", fd);
